...
automagically install it for you.
...
=head2 Depricated Widgets and Functions
...
For the most part, I have tried to emmulate the official interface to FLTK but
...
If a change I mention here chaffes you the wrong way, you're free to (within
...
The latter two are used extensivly in the tests that come with fltk but I
