package inc::MBX::FLTK;
{
    ...
    {    # Includes apidoc
        ...
        sub ACTION_apidoc {
            ...
            for my $package (sort { lc $a cmp lc $b }
                             keys %{$parser->{'apidoc_modules'}})
            {   printf "Generating documentation for %s... ", $package;
