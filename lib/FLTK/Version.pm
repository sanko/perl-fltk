package FLTK::Version;
{
    ...
    use warnings;
    use version qw[qv];
    our $VERSION_BASE = 0; our $FLTK_SVN = 6671; our $UNSTABLE_RELEASE = 1; our $VERSION = sprintf(($UNSTABLE_RELEASE ? q[%1d.%04d_%03d] : q[%1d.%04d]), $VERSION_BASE, $FLTK_SVN, $UNSTABLE_RELEASE);
    our $PRODUCT_TOKEN
        = sprintf
...
=for git $Id: Version.pm a404412 2009-03-24 05:36:10Z sanko@cpan.org $ for got=
