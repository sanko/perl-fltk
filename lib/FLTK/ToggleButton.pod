...
FLTK::ToggleButton - A subclass of C<FLTK::Button>

=head1 Description

This button turns the L<C<state( )>|FLTK::Widget/"state ( )"> on and off
each release of a click inside of it.

You can also convert a L<regular button|FLTK::Button> into this by doing
C<type(Button::TOGGLE)> to it.
...
C<FLTK::ToggleButton> is a subclass of L<C<FLTK::Button>|FLTK::Button>
...
=for git $Id: ToggleButton.pod 43c1956 2009-03-24 16:25:46Z sanko@cpan.org $ forgot=
