...
C<FLTK::Button> is a sublcass of L<C<FLTK::Widget>|FLTK::Widget>
...
This function provides a mess of back-compatabilty and Windows emulation
...
on the right if negative), and it assummes the glyph indicates the
