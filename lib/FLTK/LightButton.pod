...
FLTK::LightButton - A subclass of C<FLTK::CheckButton>

=head1 Description

This button turns the L<C<value( )>|FLTK::Button> on and off each release
of a click inside of it, and displays a light to show the user this. This
style was designed for the original Forms library and has been copied
into Discreet products and many other pieces of software that originated
with SGI machines.

When off the light is L<C<color( )>|FLTK::Widget/color ( )>, when on the
light is L<C<selection_color( )>|FLTK::Widget/selection_color ( )>.
...
C<FLTK::LightButton> is a sublcass of
