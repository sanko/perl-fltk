...
FLTK::RepeatButton - A subclass of C<FLTK::Button>

=head1 Description

The callback is done when the user pushes the button down, and then after
C<.5> second it is repeated C<10> times a second, as long as the user is
pointing at the button and holding it down.
...
C<FLTK::RepeatButton> is a subclass of L<C<FLTK::Button>|FLTK::Button>
...
=for git $Id: RepeatButton.pod 43c1956 2009-03-24 16:25:46Z sanko@cpan.org $ forgot=
