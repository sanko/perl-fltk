...
FLTK::ReturnButton - A subclass of C<FLTK::Button>

=head1 Description

Same as a normal button except the
L<C<shortcut( )>|FLTK::Widget/"shortcut ( )"> is preset to ReturnKey and
KeypadEnter, and a glyph is drawn to indicate this.
...
C<FLTK::ReturnButton> is a subclass of L<C<FLTK::Button>|FLTK::Button>
...
=for git $Id: ReturnButton.pod 43c1956 2009-03-24 16:25:46Z sanko@cpan.org $ forgot=
