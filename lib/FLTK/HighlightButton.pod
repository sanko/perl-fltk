...
FLTK::HighlightButton - A subclass of C<FLTK::Button>

=head1 Description

Same as a L<normal button|FLTK::Button> but the C<box( )> defaults to a
style that draws as a flat rectangle until the mouse points at it, then
it draws as a raised highlighted rectangle.
...
C<FLTK::HighlightButton> is a sublcass of L<C<FLTK::Button>|FLTK::Button>
